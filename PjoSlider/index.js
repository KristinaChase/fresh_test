...
textContainer.innerHTML = '<div class="text-block"><h3>Annabeth Chase</h3></div><div class="text-block"><h3>Rachel Elizabeth Dare</h3></div><div class="text-block"><h3>Percy Jackson</h3></div><div class="text-block"><h3>Nico Di Angelo</h3></div>';
